...
<div class="well">
    <table>
        <tr>
            ...
            <td>
                <h4>Welcome! <span style="font-weight: 700;margin-top: 5px;"><?php echo $this->session->userdata('firstname');?></span> to Performance Management Evaluation Menu</h4>
            ...
            <div class="panel">
                <div class="panel-body" align="center">
                    <a style="text-align: center" href="<?php echo base_url();?>pmtselection/pmtlead">
                        <img src="<?php echo base_url();?>assets/img/icons/opcr.png" height="100px">
                        <br><br>
                        Evaluate OPCR
                    </a>
                </div>
            ...
            <div class="panel">
                <div class="panel-body" align="center">
                    <a style="text-align: center" href="<?php echo base_url();?>pmtselection/pmtevaluators">
                        <img src="<?php echo base_url();?>assets/img/icons/ipcr.png" height="100px">
                        <br><br>
                        Evaluate IPCR
                    </a>
                </div>
