        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h4><i class="fa fa-angle-right"></i>&nbsp;Manage Users</h4>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8" align="left">
                        ...
                        <div class="form-group col-md-12">
                            <label class="control-label">Address:<span style="color: red;font-weight: bold">*</span></label>
                            <input class="form-control clearField" type="text" id="address" placeholder="Address" required="">
                        </div>
                    </div>
...
function validate(){
    ...
    if($("#address").val() == "" || $("#address").val() == null){
        messageDialogModal("Required Field","Please provide Address");
        return false;
    }
