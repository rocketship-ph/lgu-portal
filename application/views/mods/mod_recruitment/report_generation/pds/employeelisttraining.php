...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/employeelisttraining" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        Employee List - Trainings/Seminars Attended
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Employee List Based on Trainings and Seminars Attended</legend>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive" id="tblcont1" style="display: none">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6" align="left" style="padding-left: 0">
                                    <p><b>Employee List Based on Trainings and Seminars Attended</b><br>
                        ...
                        <table id="tblreport1" class="table table-bordered" cellspacing="0" width="100%" >
                            ...
                            <tr>
                                ...
                                <th style="text-align: center" align="center" colspan="6" >TRAININGS/SEMINARS</th>
                            </tr>
                            <tr>
                                <th style="text-align: center;vertical-align: middle" align="center" rowspan="2" width="195">Title</th>
                                ...
                                <th style="text-align: center;vertical-align: middle" align="center" rowspan="2">Conducted or Sponsored by</th>
                            </tr>
                            <tr>
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>reportgenerationmanagement/employeelisttraining",
            type: "POST",
            dataType: "json",
