...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/joborderemployee" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Job Order Employees</legend>
            <div class="row">
                <div class="col-md-12">
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('Employee List - JOB ORDER')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "JobOberEmployeeList" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "JobOberEmployeeList" + moment().format("YYYY-MM-DD"),
                    message: 'Employee List - JOB ORDER',
...
function generateChart(data){
    ...
    chartObj['chartTitle'] = 'Job Order Employee List';
    ...
    function drawChart() {
        ...
        data.addColumn('number', 'Total Number of Job Order Employee');
