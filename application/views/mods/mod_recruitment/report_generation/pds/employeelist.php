...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/employeelist" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Employee List Report</legend>
            <div class="row">
                <div class="col-md-12">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "buttons": [
                ...
                {
                    extend: 'excelHtml5',
                    title: "EmployeeList" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "EmployeeList" + moment().format("YYYY-MM-DD"),
