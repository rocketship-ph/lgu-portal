...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/employeelistenterlgu" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        Employee List - Date Entered LGU
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Employees Based on Date Entered LGU</legend>
            <div class="row">
                <div class="col-md-12">
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/employeelistenterlgu",
                "type": "POST",
                "dataType": "json",
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('Employee List - Date Entered LGU')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "EmployeeListDateEnteredLGU" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "EmployeeListDateEnteredLGU" + moment().format("YYYY-MM-DD"),
                    message: 'Employee List - Date Entered LGU',
