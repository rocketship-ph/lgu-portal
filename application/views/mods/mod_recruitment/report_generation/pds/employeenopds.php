...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/employeenopds" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        Employee without PDS Report
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List Employees With No PDS Data</legend>
            <div class="row">
                <div class="col-md-12">
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/employeenopds",
                "type": "POST",
                "dataType": "json",
                "data": {
            ...
            "columns": [
                ...
                {"data": "department"},
                {"data": function(data){
                    return data.address == "" || data.address == null ? "-" : data.address;
                }},
                {"data": "contactnumber"},
                {"data": "gender"},
                {"data": function(data){
                    return moment(data.birthday).format("MMMM DD, YYYY");
                }}
            ],
            "sDom": 'Blfrtip',
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('List Employee With No PDS Data')
                            .css('font-size', '15pt');
    ...
    function generateChart(data){
        ...
        chartObj['chartTitle'] = 'Employee With No PDS Data';
