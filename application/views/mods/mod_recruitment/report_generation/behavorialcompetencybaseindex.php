...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/behavioralcompetencybaseindex" style="height: 60px;width:60px;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Behavioral Competency Based Index Report</legend>
            <div class="row">
                <div class="col-md-12">
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/behavorialcompetencybaseindex",
                "type": "POST",
                "dataType": "json",
