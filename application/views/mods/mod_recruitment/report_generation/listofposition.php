    ...
    <tr>
        ...
        <td>
            <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                <a href="<?php echo base_url();?>reports/listofposition" style="height: 60px;width:60px;text-align: center;border-radius: 5px;">
                    <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                    <br>
                    List of Position Report
                </a>
            </div>
        </td>
        <td align="center" width="20px">
...
function loadReport() {
    ...
    $("#tblreport1").dataTable({
        ...
        "order": [[0, "desc"]],
        "ajax": {
            "url": "<?php echo base_url(); ?>reportgenerationmanagement/listofposition",
            "type": "POST",
            "dataType": "json",
...
function generateChart(data){
    ...
    chartObj['chartTitle'] = 'List of Position';
    chartObj['data'] = composeData(data,'groupposition');
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Group Position');
        data.addColumn('number', 'Total Number of Position');
