...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/backgroundinvestigationexam" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        Background Investigation Exam Report
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Background Investigation Exam</legend>
            <div class="row">
                <div class="col-md-12">
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "desc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/biexam",
                "type": "POST",
                "dataType": "json",
                "data": {
            ...
            "columns": [
                {"data": function (data) {
                    return moment(data.encodedate).format('MMM DD, YYYY hh:mm:ss A');}
                },
                {"data": "encodername"},
                {"data": "userlevel"},
                {"data": "department"},
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('Background Investigation Exam')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "BackgroundInvestigationExam" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "BackgroundInvestigationExam" + moment().format("YYYY-MM-DD"),
                    message: 'Background Investigation Exam',
