...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/corecompetencybaseindex" style="height: 60px;width:60px;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Core Competency Based Index Report</legend>
            <div class="row">
                <div class="col-md-12">
...
<script type="application/javascript">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/corecompetencybaseindex",
                "type": "POST",
                "dataType": "json",
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('Core Competency Based Index Report')
                            .css('font-size', '15pt');
                        $(win.document.body)
                ...
                {
                    extend: 'excelHtml5',
                    title: "CoreCompetencyBasedIndexReport" + moment().format("YYYY-MM-DD")
                }
//                ,{
//                    extend: 'pdfHtml5',
//                    title: "CoreCompetencyBasedIndexReport" + moment().format("YYYY-MM-DD"),
//                    message: 'Core Competency Based Index Report',
