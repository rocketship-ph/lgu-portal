...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/applicantlocalnonlocal" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Local and Non-Local Applicants Report</legend>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" id="type">
                                <option value="ALL" selected disabled>- Select Applicant Type -</option>
                                <option value="ALL">All Applicants</option>
                                <option value="LOCAL">Local Applicant</option>
                                <option value="NON-LOCAL">Non-Local Applicant</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<script type="application/javascript">
    ...
    function loadReport(type) {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/localnonlocalapplicants",
                "type": "POST",
                "dataType": "json",
                "data": {
                    "TYPE":type
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('List of '+$("#type option:selected").val()+' Applicants')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "ListOf"+$("#type option:selected").val()+"Applicants" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "ListOf"+$("#type option:selected").val()+"Applicants" + moment().format("YYYY-MM-DD"),
                    message: 'List of '+$("#type option:selected").val()+' Applicants',
...
function generateChart(data){
    ...
    chartObj['chartTitle'] = 'List of Local and Non-Local Applicants';
    chartObj['data'] = composeData(data,'area');
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Local and Non-Local Applicants');
        data.addColumn('number', 'Total Number of Applicants');
