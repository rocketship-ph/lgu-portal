...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/applicantper" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        Applicants Per Address/Position Report
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>Applicants Per Area, Address & Position Report</legend>
            <div class="row">
...
function loadReport() {
    ...
    $("#tblreport1").dataTable({
        ...
        "order": [[0, "asc"]],
        "ajax": {
            "url": "<?php echo base_url(); ?>reportgenerationmanagement/applicantsper",
            "type": "POST",
            "dataType": "json",
            "data": {
                "ISQUALIFIED":"YES"
...
function generateChart(data){
    ...
    chartObj['chartTitle'] = 'List of Applicants Per Area, Address and Position';
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Applicants Record');
        data.addColumn('number', 'Total Number of Applicants Per Area, Address and Position');
