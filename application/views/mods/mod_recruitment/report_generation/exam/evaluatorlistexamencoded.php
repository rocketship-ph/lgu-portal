...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/evaluatorlistexamencoded" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        List of Evaluators Exam Encoded Report
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Evaluators Exam Encoded Report</legend>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
