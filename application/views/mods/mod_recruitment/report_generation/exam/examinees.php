...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/examinees" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Examinees</legend>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
...
<script type="application/javascript">
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.Code == "00"){
                    ...
                    select.append('<option value="ALL">ALL EXAMINEES</option>');
    ...
    function loadReport(data) {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "desc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/examinees",
                "type": "POST",
                "dataType": "json",
                "data": {
                    "REQUESTNUMBER":data
