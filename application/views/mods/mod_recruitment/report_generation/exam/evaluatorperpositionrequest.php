...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/evaluatorperpositionrequest" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
                        <img src="<?php echo base_url();?>assets/img/icons/generic_report.png" height="40px">
                        <br>
                        List of Evaluator Per Position Request Report
                    </a>
                </div>
            </td>
            <td align="center" width="20px">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Evaluator Per Position Request</legend>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
...
<script type="application/javascript">
    ...
    function loadReport(data) {
        ...
        $("#tblreport1").dataTable({
            ...
            "order": [[0, "asc"]],
            "ajax": {
                "url": "<?php echo base_url(); ?>reportgenerationmanagement/evaluatorperpositionrequest",
                "type": "POST",
                "dataType": "json",
                "data": {
                    "REQUESTNUMBER":data
            ...
            "columns": [
                {"data": function(data){
                    return moment(data.dateassigned).format("MMM DD YYYY hh:mm:ss A");
                }},
                {"data": "evaluatorname"},
                {"data": "userlevel"},
                {"data": "requestnumber"},
