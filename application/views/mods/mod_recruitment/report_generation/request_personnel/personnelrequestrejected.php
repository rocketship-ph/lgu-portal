...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/personnelrequestrejected" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of Rejected Personnel Request</legend>
            <div class="row">
                <div class="col-md-12">
    ...
    function loadReport() {
        ...
        $("#tblreport1").dataTable({
            ...
            "columns": [
                ...
                {"data": "position"},
                {"data": function (data) {
                    return moment(data.daterejected).format('MMM DD, YYYY hh:mm:ss A');}
                },
                {"data": function(data){
                    return data.rejectedby+ ' ['+data.rejectuserlevel+']';
                }},
                {"data": "remarks"}
            ],
            "sDom": 'Blfrtip',
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('List of Rejected Requests for Personnel')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "PersonnelRequestRejected" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "PersonnelRequestRejected" + moment().format("YYYY-MM-DD"),
                    message: 'List of Rejected Requests for Personnel',
