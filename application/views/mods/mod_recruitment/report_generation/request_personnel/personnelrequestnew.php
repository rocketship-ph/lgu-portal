...
<div class="well">
        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>reports/personnelrequestnew" style="min-height: 90px;width:60px;height:auto;text-align: center;border-radius: 5px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <legend>List of New Personnel Request</legend>
            <div class="row">
                <div class="col-md-12">
            ...
            "buttons": [
                {
                    ...
                    customize: function (win) {
                        ...
                        $(win.document.body).find('h1')
                            .text('List of New Requests for Personnel')
                            .css('font-size', '15pt');
                    }
                },
                {
                    extend: 'excelHtml5',
                    title: "PersonnelRequestNew" + moment().format("YYYY-MM-DD")
                },
                {
                    extend: 'pdfHtml5',
                    title: "PersonnelRequestNew" + moment().format("YYYY-MM-DD"),
                    message: 'List of New Requests for Personnel',
