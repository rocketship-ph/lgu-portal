                   ...
                   <!--  <table id="tblreport1" class="display compact responsive" cellspacing="0" width="100%" >
                    ...
                    <table class="tblanalytics2" style="width: 100%;" border="2">
                       <tbody>
                          ...
                          <tr>
                             <td>66 and above</td>
                             <td><span id="y66abovePM"></span></td>
                             <td><span id="y66abovePF"></span></td>
                             <td><span id="y66abovePTotal"></span></td>
                             <td><span id="y66aboveEM"></span></td>
                             <td><span id="y66aboveEF"></span></td>
                             <td><span id="y66aboveETotal"></span></td>
                             <td><span id="y66aboveCTM"></span></td>
                             <td><span id="y66aboveCTF"></span></td>
                             <td><span id="y66aboveCTTotal"></span></td>
                             <td><span id="y66aboveCM"></span></td>
                             <td><span id="y66aboveCF"></span></td>
                             <td><span id="y66aboveCTotal"></span></td>
                             <td><span id="y66aboveJM"></span></td>
                             <td><span id="y66aboveJF"></span></td>
                             <td><span id="y66aboveJTotal"></span></td>
                             <td><span id="y66aboveSTM"></span></td>
                             <td><span id="y66aboveSTF"></span></td>
                             <td><span id="y66aboveGTotal"></span></td>
                          </tr>
                          <tr>
...
var age20belowM = [];var age20belowMP = [];var age20belowME = [];var age20belowMCT = [];var age20belowMC = [];var age20belowMJ = [];
...
var age20belowF = [];var age20belowFP = [];var age20belowFE = [];var age20belowFCT = [];var age20belowFC = [];var age20belowFJ = [];
...
function countAgeRange(data){
            ...
            if(value<=20){
                if(data[i]['employmentstatus'].toUpperCase()=="CASUAL"){
                    if(data[i]['gender']=="MALE"){
                        age20belowMC.push(value);
                    } else {
                        age20belowFC.push(value);
                    }
                } else if(data[i]['employmentstatus'].toUpperCase()=="PERMANENT"){
                    if(data[i]['gender']=="MALE"){
                        age20belowMP.push(value);
                    } else {
                        age20belowFP.push(value);
                    }
                } else if(data[i]['employmentstatus'].toUpperCase()=="ELECTED"){
                    if(data[i]['gender']=="MALE"){
                        age20belowME.push(value);
                    } else {
                        age20belowFE.push(value);
                    }
                } else if(data[i]['employmentstatus'].toUpperCase()=="CO-TERMINOUS"){
                    if(data[i]['gender']=="MALE"){
                        age20belowMCT.push(value);
                    } else {
                        age20belowFCT.push(value);
                    }
                } else {
                    if(data[i]['gender']=="MALE"){
                        age20belowMJ.push(value);
                    } else {
                        age20belowFJ.push(value);
                    }
                }

                if(data[i]['gender']=="MALE"){
                    age20belowM.push(value);
                    m++;
                } else {
                    age20belowF.push(value);
                    f++;
                }
    ...
    $("#tblcont1").append('<table class="tblanalytics"  style="width: 100%;" border="2" cellpadding="10" > <tbody> <tr> <td><b>Age Range</b></td> <td width="15%"><b>Male</b></td> <td width="15%"><b>Female</b></td> <td width="15%"><b>Total</b></td> </tr> <tr> <td>Below 21 years old</td> <td>'+age20belowM.length+'</td> <td>'+age20belowF.length+'</td> <td><b>'+sum(age20belowM.length,age20belowF.length)+'</b></td> </tr><tr> <td>21-35 years old</td> <td>'+age21to35M.length+'</td> <td>'+age21to35F.length+'</td> <td><b>'+sum(age21to35M.length,age21to35F.length)+'</b></td> </tr> <tr> <td>36-45 years old</td> <td>'+ age36to45M.length +'</td> <td>'+age36to45F.length+'</td> <td><b>'+sum(age36to45M.length,age36to45F.length)+'</b></td> </tr> <tr> <td>46-55 years old</td> <td>'+age46to55M.length+'</td> <td>'+age46to55F.length+'</td> <td><b>'+sum(age46to55M.length,age46to55F.length)+'</b></td> </tr> <tr> <td>56-65 years old</td> <td>'+age56to65M.length+'</td> <td>'+age56to65F.length+'</td> <td><b>'+sum(age56to65M.length,age56to65F.length)+'</b></td> </tr> <tr> <td>66 and above</td> <td>'+age66to70M.length+'</td> <td>'+age66to70F.length+'</td> <td><b>'+sum(age66to70M.length,age66to70F.length)+'</b></td> </tr> <tr> <td><b>Grand Total</b></td> <td><b>'+m+'</b></td> <td><b>'+f+'</b></td> <td><b>'+sum(m,f)+'</b></td> </tr> </tbody> </table><br>');
    //BELOW 21
    $("#below21STM").text(age20belowM.length);
    $("#below21STF").text(age20belowF.length);
    $("#below21GTotal").append("<b>"+sum(age20belowM.length,age20belowF.length)+"</b>");

    $("#below21CM").text(age20belowMC.length);
    $("#below21CF").text(age20belowFC.length);
    $("#below21CTotal").append("<b>"+sum(age20belowMC.length,age20belowFC.length)+"</b>");

    $("#below21JM").text(age20belowMJ.length);
    $("#below21JF").text(age20belowFJ.length);
    $("#below21JTotal").append("<b>"+sum(age20belowMJ.length,age20belowFJ.length)+"</b>");

    $("#below21PM").text(age20belowMP.length);
    $("#below21PF").text(age20belowFP.length);
    $("#below21PTotal").append("<b>"+sum(age20belowMP.length,age20belowFP.length)+"</b>");

    $("#below21EM").text(age20belowME.length);
    $("#below21EF").text(age20belowFE.length);
    $("#below21ETotal").append("<b>"+sum(age20belowME.length,age20belowFE.length)+"</b>");

    $("#below21CTM").text(age20belowMCT.length);
    $("#below21CTF").text(age20belowFCT.length);
    $("#below21CTTotal").append("<b>"+sum(age20belowMCT.length,age20belowFCT.length)+"</b>");

    //21 to 35
    $("#y21to35STM").text(age21to35M.length);
    $("#y21to35STF").text(age21to35F.length);
    $("#y21to35GTotal").append("<b>"+sum(age21to35M.length,age21to35F.length)+"</b>");

    $("#y21to35CM").text(age21to35MC.length);
    $("#y21to35CF").text(age21to35FC.length);
    $("#y21to35CTotal").append("<b>"+sum(age21to35MC.length,age21to35FC.length)+"</b>");

    $("#y21to35JM").text(age21to35MJ.length);
    $("#y21to35JF").text(age21to35FJ.length);
    $("#y21to35JTotal").append("<b>"+sum(age21to35MJ.length,age21to35FJ.length)+"</b>");

    $("#y21to35PM").text(age21to35MP.length);
    $("#y21to35PF").text(age21to35FP.length);
    $("#y21to35PTotal").append("<b>"+sum(age21to35MP.length,age21to35FP.length)+"</b>");

    $("#y21to35EM").text(age21to35ME.length);
    $("#y21to35EF").text(age21to35FE.length);
    $("#y21to35ETotal").append("<b>"+sum(age21to35ME.length,age21to35FE.length)+"</b>");

    $("#y21to35CTM").text(age21to35MCT.length);
    $("#y21to35CTF").text(age21to35FCT.length);
    $("#y21to35CTTotal").append("<b>"+sum(age21to35MCT.length,age21to35FCT.length)+"</b>");

    //36 to 45
    $("#y36to45STM").text(age36to45M.length);
    $("#y36to45STF").text(age36to45F.length);
    $("#y36to45GTotal").append("<b>"+sum(age36to45M.length,age36to45F.length)+"</b>");

    $("#y36to45CM").text(age36to45MC.length);
    $("#y36to45CF").text(age36to45FC.length);
    $("#y36to45CTotal").append("<b>"+sum(age36to45MC.length,age36to45FC.length)+"</b>");

    $("#y36to45JM").text(age36to45MJ.length);
    $("#y36to45JF").text(age36to45FJ.length);
    $("#y36to45JTotal").append("<b>"+sum(age36to45MJ.length,age36to45FJ.length)+"</b>");

    $("#y36to45PM").text(age36to45MP.length);
    $("#y36to45PF").text(age36to45FP.length);
    $("#y36to45PTotal").append("<b>"+sum(age36to45MP.length,age36to45FP.length)+"</b>");

    $("#y36to45EM").text(age36to45ME.length);
    $("#y36to45EF").text(age36to45FE.length);
    $("#y36to45ETotal").append("<b>"+sum(age36to45ME.length,age36to45FE.length)+"</b>");

    $("#y36to45CTM").text(age36to45MCT.length);
    $("#y36to45CTF").text(age36to45FCT.length);
    $("#y36to45CTTotal").append("<b>"+sum(age36to45MCT.length,age36to45FCT.length)+"</b>");

    //46 to 55
    $("#y46to55STM").text(age46to55M.length);
    $("#y46to55STF").text(age46to55M.length);
    $("#y46to55GTotal").append("<b>"+sum(age46to55M.length,age46to55F.length)+"</b>");

    $("#y46to55CM").text(age46to55MC.length);
    $("#y46to55CF").text(age46to55FC.length);
    $("#y46to55CTotal").append("<b>"+sum(age46to55MC.length,age46to55FC.length)+"</b>");

    $("#y46to55JM").text(age46to55MJ.length);
    $("#y46to55JF").text(age46to55FJ.length);
    $("#y46to55JTotal").append("<b>"+sum(age46to55MJ.length,age46to55FJ.length)+"</b>");

    $("#y46to55PM").text(age46to55MP.length);
    $("#y46to55PF").text(age46to55FP.length);
    $("#y46to55PTotal").append("<b>"+sum(age46to55MP.length,age46to55FP.length)+"</b>");

    $("#y46to55EM").text(age46to55ME.length);
    $("#y46to55EF").text(age46to55FE.length);
    $("#y46to55ETotal").append("<b>"+sum(age46to55ME.length,age46to55FE.length)+"</b>");

    $("#y46to55CTM").text(age46to55MCT.length);
    $("#y46to55CTF").text(age46to55FCT.length);
    $("#y46to55CTTotal").append("<b>"+sum(age46to55MCT.length,age46to55FCT.length)+"</b>");

    //56 to 65
    
    $("#y56to65STM").text(age56to65M.length);
    $("#y56to65STF").text(age56to65F.length);
    $("#y56to65GTotal").append("<b>"+sum(age56to65M.length,age56to65F.length)+"</b>");

    $("#y56to65CM").text(age56to65MC.length);
    $("#y56to65CF").text(age56to65FC.length);
    $("#y56to65CTotal").append("<b>"+sum(age56to65MC.length,age56to65FC.length)+"</b>");

    $("#y56to65JM").text(age56to65MJ.length);
    $("#y56to65JF").text(age56to65FJ.length);
    $("#y56to65JTotal").append("<b>"+sum(age56to65MJ.length,age56to65FJ.length)+"</b>");

    $("#y56to65PM").text(age56to65MP.length);
    $("#y56to65PF").text(age56to65FP.length);
    $("#y56to65PTotal").append("<b>"+sum(age56to65MP.length,age56to65FP.length)+"</b>");

    $("#y56to65EM").text(age56to65ME.length);
    $("#y56to65EF").text(age56to65FE.length);
    $("#y56to65ETotal").append("<b>"+sum(age56to65ME.length,age56to65FE.length)+"</b>");

    $("#y56to65CTM").text(age56to65MCT.length);
    $("#y56to65CTF").text(age56to65FCT.length);
    $("#y56to65CTTotal").append("<b>"+sum(age56to65MCT.length,age56to65FCT.length)+"</b>");
    ...
    $("#GTCM").text(age20belowMC.length+age21to35MC.length+age36to45MC.length+age46to55MC.length+age56to65MC.length+age66to70MC.length);
    $("#GTCF").text(age20belowFC.length+age21to35FC.length+age36to45FC.length+age46to55FC.length+age56to65FC.length+age66to70FC.length);
    $("#GTCTotal").append("<b>"+sum($("#GTCM").text(),$("#GTCF").text())+"</b>");

    $("#GTJM").text(age20belowMJ.length+age21to35MJ.length+age36to45MJ.length+age46to55MJ.length+age56to65MJ.length+age66to70MJ.length);
    $("#GTJF").text(age20belowFJ.length+age21to35FJ.length+age36to45FJ.length+age46to55FJ.length+age56to65FJ.length+age66to70FJ.length);
    $("#GTJTotal").append("<b>"+sum($("#GTJM").text(),$("#GTJF").text())+"</b>");

    $("#GTPM").text(age20belowMP.length+age21to35MP.length+age36to45MP.length+age46to55MP.length+age56to65MP.length+age66to70MP.length);
    $("#GTPF").text(age20belowFP.length+age21to35FP.length+age36to45FP.length+age46to55FP.length+age56to65FP.length+age66to70FP.length);
    $("#GTPTotal").append("<b>"+sum($("#GTPM").text(),$("#GTPF").text())+"</b>");

    $("#GTEM").text(age20belowME.length+age21to35ME.length+age36to45ME.length+age46to55ME.length+age56to65ME.length+age66to70ME.length);
    $("#GTEF").text(age20belowFE.length+age21to35FE.length+age36to45FE.length+age46to55FE.length+age56to65FE.length+age66to70FE.length);
    $("#GTETotal").append("<b>"+sum($("#GTEM").text(),$("#GTEF").text())+"</b>");

    $("#GTCTM").text(age20belowMCT.length+age21to35MCT.length+age36to45MCT.length+age46to55MCT.length+age56to65MCT.length+age66to70MCT.length);
    $("#GTCTF").text(age20belowFCT.length+age21to35FCT.length+age36to45FCT.length+age46to55FCT.length+age56to65FCT.length+age66to70FCT.length);
...
function generateChart(data){
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Age Range Analytics');
