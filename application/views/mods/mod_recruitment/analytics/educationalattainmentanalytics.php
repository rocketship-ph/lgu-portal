        ...
        <td style="border: 1px solid #d1d1d1" >
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>analytics/educationalattainmentanalytics" style="height: 60px;width:60px;text-align: center;border-radius: 5px;">
...
<div class="row">
    ...
    <div class="col-md-12" id="container">
        <legend>Highest Educational Attainment Analytics</legend>
...
function generateChart(data){
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Highest Educational Attainment Analytics');
