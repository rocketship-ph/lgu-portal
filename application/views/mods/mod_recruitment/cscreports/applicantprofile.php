...
<div class="row">
    ...
    <div class="col-md-12" id="container">
        <legend>Profile of Applicants</legend>
       <div class="row">
...
function loadReport(month,year) {
    ...
    $("#divSignatory").empty();
     $.ajax({
            url: "<?php echo base_url();?>analyticsmanagement/getapplicantprofile",
            type: "POST",
            dataType: "json",
            data: {
                "MONTH":month,
            ...
            success: function(data){
                ...
                if(data.Code == "00"){
                    ...
                    $('#tbldata').append('<tr>' +
                        ...
                        '    <th width="2%"><b>SEX</b></th>' +
                        '    <th width="15%"><b>ADDRESS</b></th>' +
                        '    <th width="7%"><b>CONTACT DETAILS</b></th>' +
                        '    <th width="17%"><b>EDUCATION</b></th>' +
                        '    <th width="10%"><b>EXPERIENCE</b></th>' +
                        '    <th width="10%"><b>TRAINING</b></th>' +
                        '    <th width="10%"><b>ELIGIBILITY</b></th>' +
                        '  </tr>');
                    var count = 1;
                    for(var key in data.details){
                        $('#tbldata').append('<tr>' +
                            '    <td width="2%">'+count+'</td>' +
                            '    <td width="25%">'+isEmpty(data.details[key].fullname)+'</td>' +
                            '    <td width="2%">'+isEmpty(data.details[key].age)+'</td>' +
                            '    <td width="2%">'+isEmpty(data.details[key].sex)+'</td>' +
                            '    <td width="15%">'+isEmpty(data.details[key].address)+'</td>' +
                            '    <td width="14%">'+isEmpty(data.details[key].contactdetails)+'</td>' +
                            '    <td width="10%">'+isEmpty(data.details[key].education)+'</td>' +
                            '    <td width="10%">'+isEmpty(data.details[key].experience)+' yrs</td>' +
                            '    <td width="10%">'+isEmpty(data.details[key].training)+'</td>' +
                            '    <td width="10%">'+displayEligibility(data.details[key].civilservice)+'</td>' +
                            '  </tr>');
                        count++;
                    }
                    $('#tbldata').append('<tr><td colspan="10" align="center">xxxxxxxxx nothing follows xxxxxxxxx</td></tr>');
