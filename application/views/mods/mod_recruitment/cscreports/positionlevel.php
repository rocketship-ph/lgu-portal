        ...
        <tr>
            ...
            <td>
                <div class="panel panel-menu" align="center" id="panel_requestpersonnelreports">
                    <a href="<?php echo base_url();?>cscreports/positionlevel" style="height: 60px;width:60px;text-align: center;border-radius: 5px;">
...
<div class="row">
    ...
    <div class="col-md-12" id="container">
        <legend>Levels of Position </legend>
...
function generateChart(data){
    ...
    function drawChart() {
        ...
        data.addColumn('string', 'Levels of Position ');
